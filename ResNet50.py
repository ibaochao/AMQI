...
class ResNet(nn.Module):
    ...
    def __init__(self, block, blocks_num, groups=1, width_per_group=64):
        ...
        # self.myavgpool = nn.AdaptiveAvgPool2d((1, 1))  # output size = (1, 1)
        # self.myfc = nn.Linear(512 * block.expansion, 1)
    ...
    def forward(self, x):  # B 3 224 224
        ...
        # x = self.myavgpool(x)  # B 2048 1 1
        # x = torch.flatten(x, 1)  # B 2048*1*1 = B 2048
        # x = self.myfc(x)  # B 2048 -> B 1
        return out


def ResNet50(pretrained_model_path='', pretrained=False):
    # https://download.pytorch.org/models/resnet50-0676ba61.pth
    model = ResNet(Bottleneck, [3, 4, 6, 3])
    if pretrained:
        print("Load resnet50-0676ba61.pth")
        ...
        print("Not Load resnet50-0676ba61.pth")
    return model
